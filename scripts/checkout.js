...
export function money() {
  ...
  document.querySelector('.payment-summary-money1')
    .innerHTML = '$' + totalPrice / 100

  document.querySelector('.payment-summary-money2')
    .innerHTML = "$" + 4.99

  document.querySelector('.payment-summary-money3')
    .innerHTML = '$' + (totalPrice / 100 + 4.99).toFixed(2)

  document.querySelector('.payment-summary-money4')
    .innerHTML = '$' + ((totalPrice / 100 + 4.99) / 10).toFixed(2)

  document.querySelector('.payment-summary-money5')
    .innerHTML = '$' + ((totalPrice / 100 + 4.99) * 1.1).toFixed(2)
}
